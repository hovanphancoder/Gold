                    ...
                    <div class="card mb-0">
                        <div class="card-body p-4">
                            ...
                            <div class="text-center">
                                <div class="my-3">
                                    <a href="index.php">
                                        <span><img src="img\camera.png" alt="" height="28"></span>
                                    </a>
                                </div>
                                <h5 class="text-muted text-uppercase py-3 font-16">Đăng nhập</h5>
                            </div>

                            <form action="index.php?ctrl=login" method="post" class="mt-2">
                                ...
                                <div class="form-group mb-3">
                                    <input class="form-control" type="password" required="" id="password" name="pass"
                                ...
                                <div class="form-group text-center">
                                    <button class="btn btn-success btn-block waves-effect waves-light" name="btn_submit"
                                        type="submit">
                                        Log In </button>
                                </div>
