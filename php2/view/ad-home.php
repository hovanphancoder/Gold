            ...
            <div class="row">
                <div class="col-md-6 col-xl-3">
                    <div class="card-box tilebox-one">
                        ...
                        <h6 class="text-muted text-uppercase mt-0">Đơn hàng đã thanh toán</h6>
                        <h3 class="my-3" data-plugin="counterup">
                            <?php
                        foreach($countOrder as $g){
                            echo $g['NumberOrder'];
                        }
                        ?>
                        </h3>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card-box tilebox-one">
                        ...
                        <h6 class="text-muted text-uppercase mt-0">Tổng thu nhập
                            <span style="text-transform: lowercase;"> (đ)</span>
                        </h6>
                        <h3 class="my-3" data-plugin="counterup">
                            <?php
                        foreach($tkmoney as $l){

                            echo number_format($l['number'],0,".",",");
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card-box tilebox-one">
                        ...
                        <h3 class="my-3" data-plugin="counterup">
                            <?php
                        foreach($countOrderTT as $o){
                            echo $o['NumberOrderTT'];
                        }
                        ?>
                        </h3>
                        <!-- <span class="badge badge-pink mr-1"> 0% </span> <span 
                        class="text-muted">From previousperiod</span> -->
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card-box tilebox-one">
                        ...
                        <h6 class="text-muted text-uppercase mt-0"> Tổng sản phẩm </h6>
                        <h3 class="my-3" data-plugin="counterup">
                            <?php
                        foreach($countProduct as $u){
                            echo $u['NumberProduct'];
                        }
                        ?>
                        </h3>
