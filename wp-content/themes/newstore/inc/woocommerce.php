...
<a class="cart-link-contents" href="<?php echo esc_url( wc_get_cart_url() ); ?>">
    ...
    <div class="header-cart-top-link-right">
        <div class="label"><?php esc_html_e( 'Tổng đơn hàng', 'newstore' ); ?></div>
    ...
    <div class="site-header-cart-inner">
        ...
        <div class="header-cart-conetnts">
            <div class="header-cart-top">
                ...
                <div class="header-cart-top-right"><a class="header-cart-top-link"
                        href="<?php echo esc_url( wc_get_cart_url() ); ?>"><?php esc_html_e( 'Xem giỏ hàng', 'newstore' ); ?></a>
                </div>
            </div>
...
<div class="shop-product-count-dropdown-con">
    ...
    <select name="product_count" id="woocommerce_product_count_select">
        <option value="<?php echo esc_url( add_query_arg('count', $product_count1) ); ?>"
            <?php selected( $selected_count, $product_count1, true ); ?>><?php echo $product_count1; ?></option>
        <option value="<?php echo esc_url( add_query_arg('count', $product_count2) ); ?>"
            <?php selected( $selected_count, $product_count2, true ); ?>><?php echo $product_count2; ?></option>
        <option value="<?php echo esc_url( add_query_arg('count', $product_count3) ); ?>"
            <?php selected( $selected_count, $product_count3, true ); ?>><?php echo $product_count3; ?></option>
        <option value="<?php echo esc_url( add_query_arg('count', $product_count4) ); ?>"
            <?php selected( $selected_count, $product_count4, true ); ?>><?php echo $product_count4; ?></option>
        <option value="<?php echo esc_url( add_query_arg('count', $product_count5) ); ?>"
            <?php selected( $selected_count, $product_count5, true ); ?>><?php echo $product_count5; ?></option>
    </select>
</div>
<?php
}
...
function newstore_get_page_labels() {
	$lables = array(
		'myaccount' => '<i class="fa fa-user"></i> ' . __('Tài Khoảng của bạn', 'newstore'),
		'orders'    => '<i class="fa fa-archive"></i>'.__('Đơn hàng của tôi', 'newstore'),
		'details'   => '<i class="fa fa-user-circle-o"></i>'.__('Chi tiết tài khoảng', 'newstore'),
		'login'     => '<i class="fa fa-sign-in"></i> ' . __('Đăng nhập', 'newstore'),
		'register'  => '<i class="fa fa-user-plus"></i> ' . __('Đăng ký', 'newstore'),
		'cart'      => '<i class="fa fa-shopping-basket"></i> ' . __('Giỏ Hàng', 'newstore'),
		'checkout'  => '<i class="fa fa-check-circle-o"></i> ' . __('Kiển tra', 'newstore'),
		'wishlist'  => '<i class="fa fa-heart"></i> ' . __('Danh sách yêu thích', 'newstore'),
		'logout'    => '<i class="fa fa-sign-out"></i> ' . __('Đăng nhập', 'newstore'),
	);
